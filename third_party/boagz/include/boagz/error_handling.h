...
#define BGZ_ASSERTMSG(condition, msg, ...)                                                   \
do                                                                                    \
{                                                                                     \
if (!(condition))                                                                 \
Bgz::ErrorReport_DEPRECATED(#condition, __func__, __FILE__, __LINE__, msg, __VA_ARGS__); \
} while (0)
...
namespace Bgz
{
    ...
    template <typename... ArgTypes> inline auto ErrorReport_DEPRECATED(const char* errCondition, const char* functionName, const char* file, int lineNumber, const char* errMessage, ArgTypes... args) -> void
    {
